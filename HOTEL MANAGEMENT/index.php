...
<head>
    ...
    <title>Serenity Peak - HOME</title>
...
<body class="bg-light">
    ...
    <div class="container">
        <div class="row">
            <?php
             $room_res = select_query("SELECT * FROM `rooms` WHERE `status`=? AND `removed`=? ORDER BY `id` DESC LIMIT 3",[1,0],'ii');
             ...
             while($room_data = mysqli_fetch_assoc($room_res)){
                ...
                if(isset($_SESSION['login']) && $_SESSION['login']==true){
                    ...
                    $book_btn = "<button onclick='checkLoginToBook($login,$room_data[id])' href='#' class='btn btn-sm text-white custom-bg shadow-none'>Book Now</button>";
                }
