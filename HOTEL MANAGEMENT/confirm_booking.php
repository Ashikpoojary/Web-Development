...
<head>
    ...
    <title>Serenity Peak - CONFIRM BOOKING</title>
...
<body class="bg-light">
    ...
    */
     ...
     // filter and get rooms & user data

     $data = filteration($_GET);

     $room_res = select_query("SELECT * FROM `rooms` WHERE `id`=? AND `status`=? AND `removed`=?",[$data['id'],1,0],'iii');
     ...
     $user_res = select_query("SELECT * FROM `user_cred` WHERE `id`=? LIMIT 1",
     [$_SESSION['uId']],"i");
                        ...
                        <form action="#">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <button name="pay_now" class="btn w-100 text-white custom-bg shadow-none mb-1" aria-disabled="true" >Pay Now</button>
                                </div>
                            </div>
                        </form>
                    </div>
