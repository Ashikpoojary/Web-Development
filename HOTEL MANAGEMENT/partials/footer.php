...
<div class="container-fluid bg-white mt-5">
    <div class="row">
        <div class="col-lg-4 p-4">
            ...
            <p><?php echo $settings_r['site_about'] ?> Lorem ipsum dolor sit amet consectetur, adipisicing elit.
        ...
        <div class="col-lg-4 p-4">
            ...
            <?php
                    if($contact_r['tw']!=''){
                        echo<<<data
                        <a href="$contact_r[tw]" class="d-inline-block text-dark text-decoration-none mb-3">
