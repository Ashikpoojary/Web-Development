...
<head>
    ...
    <title>Serenity Peak - ROOMS</title>
...
<body class="bg-light">
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <nav class="navbar navbar-expand-lg bg-white rounded shadow">
                    <div class="container-fluid flex-lg-column align-items-stretch ">
                        ...
                        <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                            <div class="border bg-light p-4 rounded m-2 ">
                            ...
                            <div class="border bg-light p-4 rounded m-2 ">
                                ...
                                <div class="mb-2">
                                    ...
                                    <label type="data" class="form-label" for="f1">Facility one</label>
                                </div>
                                <div class="mb-2">
                                    <input type="checkbox" id="f2" class="form-check-input shadow-none me-1">
                                    <label type="data" class="form-label" for="f2">Facility two</label>
                                </div>
                                <div class="mb-2">
                                    <input type="checkbox" id="f3" class="form-check-input shadow-none me-1">
                                    <label type="data" class="form-label" for="f3">Facility three</label>
                                </div>
                            </div>
                            <div class="border bg-light p-4 rounded m-2 ">
            ...
            <?php
             $room_res = select_query("SELECT * FROM `rooms` WHERE `status`=? AND `removed`=?",[1,0],'ii');
