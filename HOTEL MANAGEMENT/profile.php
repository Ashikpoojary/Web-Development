...
<head>
    ...
    <title>Serenity Peak - Profile</title>
</head>
...
<body class="bg-light">
    <?php
        ...
        $u_exist = select_query("SELECT * FROM `user_cred` WHERE `id`=? LIMIT 1",[$_SESSION['uId']],'s');
                    ...
                    <form id="info-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input name="phonenum" type="numbers" value="<?php echo $u_fetch['phonenum'] ?>"
                                    class="form-control shadow-none" required>
                            </div>
                            <div class="col-md-4 mb-3">
